...
class AddDummyData
{
    ...
    bool addDummyCard()
    {
        ...
        const std::tuple<std::string, int, std::string, std::string, int> initCards[] = {
            ...
            {"3056-5954", 1, "John Doe", "2024-09-12", 1},
            {"5425-0990", 1, "John Doe", "2024-08-18", 1},
            {"4916-4231", 2, "Jane Smith", "2023-02-01", 2},
            {"6011-9424", 2, "Jane Smith", "2023-10-08", 2},
            {"4539-2148", 2, "Jane Smith", "2023-09-30", 2},
            {"5254-7899", 3, "Carlos Gómez", "2024-03-15", 3},
            {"5555-4444", 3, "Carlos Gómez", "2024-12-30", 3},
            {"3056-5904", 3, "Carlos Gómez", "2024-07-07", 3},
            {"4539-3646", 4, "Laura Fernández", "2023-05-20", 1},
            {"6011-9590", 4, "Laura Fernández", "2023-03-11", 1},
            {"4111-1111", 4, "Laura Fernández", "2023-11-15", 1},
            {"6011-9596", 5, "Michael Johnson", "2024-06-10", 2},
            {"3742-0126", 5, "Michael Johnson", "2024-04-05", 2},
            {"3793-2306", 5, "Michael Johnson", "2024-05-25", 2},
            {"3793-2316", 6, "Sofía Martínez", "2023-07-25", 3},
            {"4532-8734", 6, "Sofía Martínez", "2023-08-14", 3},
            {"6011-1117", 6, "Sofía Martínez", "2023-06-22", 3},
            {"4916-1123", 1, "Manuel Torres", "2024-11-30", 1},
            {"5254-9901", 2, "Isabel Romero", "2023-04-02", 2}};
